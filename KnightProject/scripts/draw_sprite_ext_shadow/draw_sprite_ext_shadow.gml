/// @description draw_sprite_ext_shadow(sprite, subimg, x, y, xscale, yscale, rot, color, alpha, shadow length, shadow direction, shadow color, shadow alpha);
/// @function draw_sprite_ext_shadow
/// @param sprite
/// @param subimg
/// @param x
/// @param y
...
7   shadow_length       The distance in pixels between sprite and shadow. 
8  shadow_direction    The direction the shadow is facing.
9  shadow_color        The color of the shadow.
10  shadow_alpha        The alpha of the shadow.
*/

//init & assign variables
var spr = argument0, img = argument1, xx = argument2,
    yy = argument3, xscale = argument4, yscale = argument5,
    angle = argument6, sh_len = argument7, sh_dir = argument8,
    sh_col = argument9, sh_alpha = argument10;
